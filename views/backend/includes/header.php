...
global $DB;
$stmtPending = $DB->query("SELECT COUNT(*) as pending FROM COMMENT WHERE attModOK = 0 AND dtDelLogCom IS NULL");
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                <div class="nav-section-title">
                    <i class="bi bi-folder"></i> Contenu
                </div>
    ...
    <div class="main-wrapper">
        ...
        <nav class="top-navbar">
            ...
            <div class="navbar-search d-none d-md-block">
                <form action="<?= ROOT_URL ?>/views/backend/search.php" method="GET">
                    <div class="input-group">
                        <span class="input-group-text bg-transparent border-end-0">
                            <i class="bi bi-search"></i>
                        </span>
                        <input type="text" class="form-control border-start-0" name="q" placeholder="Rechercher...">
                    </div>
                </form>
            </div>
            ...
            <div class="navbar-actions ms-auto">
                ...
                <div class="dropdown me-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?= ROOT_URL ?>/views/backend/moderation/comments.php">
                            ...
                            <?= $pendingCount ?> commentaire(s) en attente
                        </a>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?= ROOT_URL ?>/views/backend/profile.php">
        ...
        <main class="main-content">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= ROOT_URL ?>/views/backend/dashboard.php">Dashboard</a></li>
